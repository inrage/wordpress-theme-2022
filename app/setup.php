...
add_action('wp_enqueue_scripts', function () {
    ...
    if (has_block('core/button')) {
        wp_enqueue_style('blocks/button.css', asset('styles/blocks/button.css')->uri(), false, null);
    }
}, 100);
...
add_action('after_setup_theme', function () {
    ...
    add_image_size('project-item', 272, 482, true);
    add_image_size('expertise-item', 120, 120, true);
    add_image_size('article-item', 570, 255, true);
