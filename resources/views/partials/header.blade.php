<header class="header">
  <div class="header__top__wrapper">
    <div class="header__top">
      <div class="container">
        <a href="{!! home_url() !!}" aria-label="Pascal GAULT, Développeur Freelance" class="custom-logo-link" rel="home" aria-current="page">
        ...
        <button class="header__toggler toggle-menu--js" aria-label="Open menu">
          <svg height="30" viewbox="0 0 18 18" width="30" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 0h18v18H0z" fill="none"/>
            <path class="header__toggler__fill" d="M2 13.5h14V12H2v1.5zm0-4h14V8H2v1.5zM2 4v1.5h14V4H2z"/>
          </svg>
        </button>
        <div class="header__menu">
          ...
          <div class="header__menu__close toggle-menu--js">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 415 76"><defs><path id="a" d="M291.516 48.222L414.422.36v75h-414z"/></defs><g fill="none" fill-rule="evenodd"><use fill="none" xlink:href="#a"/><path fill="#E57E21" d="M414.422 1v51.282L312 40.886z"/><path fill="#FFF" fill-rule="nonzero" d="M402.422 23.273l-1.914-1.914-7.586 7.586-7.587-7.586-1.913 1.914 7.586 7.586-7.586 7.586 1.913 1.914 7.587-7.586 7.586 7.586 1.914-1.914-7.587-7.586z"/></g></svg>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="header__main">
    ...
    @elseif(basename(get_page_template_slug()) == 'tma-detail.blade.php')
      ...
      <div class="header__main__title--content">{!! get_field('page_desc') !!}</div>
      <div class="header__main__title--cta">
  ...
  @if(!is_404())
    <div class="header__bottom">
      <svg height="351" preserveaspectratio="xMinYMin meet" style="width: 100%; height: auto;" viewbox="0 0 1920 351" width="1920" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
        <defs>
