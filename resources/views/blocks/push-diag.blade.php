<div
  class="push-diag push-diag--top--{{ $bg_top_outer }} push-diag--push--{{ $push_color }} push-diag--bottom--{{ $bg_bottom_outer }} fullsize {{ $block->classes }}"
  {!! $bg_img ? 'style="background-image: url('.$bg_img.');"' : null !!}
>
